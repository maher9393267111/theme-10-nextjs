                        ...
                        <div className="row">
                            <div className="col-xl-10 col-lg-12 m-auto">
                                ...
                                <div className="text-center mt-30">
                                    <div className="d-inline-block support text-start">(48) 654-430-309<br />(01) 1112-111-111</div>
                                    <div className="d-inline-block location text-start">contact@example.com<br />sales@example.com</div>
