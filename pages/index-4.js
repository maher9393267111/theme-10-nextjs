                          ...
                          >
                            <div className="card-image mb-20">
                              ...
                              <Link href="/single-sidebar">
                                <img
                                  src="assets/imgs/page/homepage4/news1.png"
                                  alt=""
                                />
                              </Link>
                            </div>
                            <div className="card-info">
                              <Link href="/single-sidebar">
                                <h4 className="color-white mt-30">
                                  I work best when my space is filled with
                                  inspiration
                                </h4>
                              </Link>
                              <p className="mt-25 text-lg color-gray-700">
                                ...
                                roadrunner flapped lynx far that and jeepers
                                giggled far and far
                              </p>
                            ...
                            <div className="col-lg-12">
                              ...
                              >
                                ...
                                <div className="card-info">
                                  ...
                                  <Link href="/single-sidebar">
                                    <h5 className="mb-10 color-white">
                                      U.S. Interventions in Latin America, in
                                      Photos
                                    </h5>
                                  </Link>
                                  <div className="row mt-10">
                            ...
                            <div className="col-lg-12">
                              ...
                              >
                                ...
                                <div className="card-info">
                                  ...
                                  <Link href="/single-sidebar">
                                    <h5 className="mb-10 color-white">
                                      How to View Breast Cancer Survival Rates
                                    </h5>
                                  </Link>
                                  <div className="row mt-10">
                                    <div className="col-12">
                ...
                <div className="row align-items-end mt-30">
                  <div className="col-lg-9 wow animate__animated animate__fadeIn">
                    <h3 className="color-linear">
                      Content publishing cooperation
                  ...
                  <div
                    ...
                    data-wow-delay="0.2s"
                  >
                    <Link className="link-brand-1" href="#">
                      Learn More
                    </Link>
                  </div>
                </div>
