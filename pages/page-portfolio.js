                            ...
                            <div className="col-xl-10 col-lg-12">
                                ...
                                <nav className="mb-50">
                                    <ul className="pagination">
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a className="paimg-link paimg-prev" href="#"><i className="fi-rr-arrow-small-left" /></a>
                                        </li>
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".1s"><a className="paimg-link" href="#">1</a></li>
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".2s"><a className="paimg-link active" href="#">2</a></li>
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a className="paimg-link" href="#">3</a></li>
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".4s"><a className="paimg-link" href="#">...</a></li>
                                        <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".5s"><a className="paimg-link paimg-next" href="#"><i className="fi-rr-arrow-small-right" /></a>
                                        </li>
                                    </ul>
                                </nav>
                                <div className="text-center mt-70 mb-50">
                                ...
                                <div className="box-features bg-gray-850 border-gray-800">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4 col-md-6 mb-50 wow animate__animated animate__fadeIn" data-wow-delay="0.2s"><span className="item-icon bg-gray-950 icon-social" />
                                            <h5 className="color-white mb-15">Social<br />Manaimgment</h5>
                                            <p className="text-base color-gray-700">NetTracking" is a very powerful Web 2.0 site
                                                search engine allows you to find email allerts</p>
                                        </div>
                                    </div>
