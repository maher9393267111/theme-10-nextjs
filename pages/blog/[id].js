  ...
  return (
    <>
      <Layout>
        {blogPost && (
          <>
            {/* <img src={`/imaimgs/blog/${blogPost.img}`} class="w-100 rounded" alt="" />  */}
            {/* {blogPost.title} */}
                      ...
                      <div className="col-lg-8">
                        <div className="content-detail border-gray-800">
                          ...
                          <p className="text-lg color-gray-500 mb-50">
                            ...
                            ultricies odio porta. Eimgstas mauris placerat leo
                            phasellu s ut sit.
                          </p>
                          ...
                          <p className="text-lg color-gray-500">
                            ...
                            odio porta. Eimgstas mauris placerat leo phasellus ut
                            sit.
                          </p>
                          <div className="row mt-50">
