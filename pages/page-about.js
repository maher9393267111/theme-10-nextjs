                                ...
                                <div className="banner">
                                    <div className="row align-items-end">
                                        <div className="col-lg-6  mb-10 pt-100"><span className="text-sm-bold color-gray-600 wow animate__animated animate__fadeInUp">Hello Everyone!</span>
                                            ...
                                            <div className="row">
                                                <div className="col-lg-9">
                                                    <p className="text-base color-gray-600 wow animate__animated animate__fadeInUp">lorem ipsum dolor sit amet, consectetur adip
                                        ...
                                        <div className="col-lg-6 text-center">
                                            <div className="banner-img position-relative wow animate__animated animate__fadeIn"><img
                                            className="img-me"
                                            // style={{ heigth:'605px !important' ,width:'540px !important' ,  }}
                                            src="assets/imgs/me.jpg" alt="me" />
                                                <div className="pattern-1"><img src="assets/imgs/template/pattern-1.svg" alt="img" /></div>
                                                <div className="pattern-2"><img src="assets/imgs/template/pattern-2.svg" alt="img" /></div>
                                                <div className="pattern-3"><img src="assets/imgs/template/pattern-3.svg" alt="img" /></div>
                                                <div className="pattern-4"><img src="assets/imgs/template/pattern-4.svg" alt="img" /></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="box-features mt-4 bg-gray-850 border-gray-800">
                                    <div className="row">
