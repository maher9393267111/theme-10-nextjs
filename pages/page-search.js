                                        ...
                                        <div className="col-lg-8 m-auto">
                                            <div className="box-list-posts mt-30">
                                                <div className="card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn">
                                                    <div className="card-imaimg hover-up">
                                                        <div className="box-author mb-20"><img src="assets/imgs/paimg/healthy/author.png" alt="imgnz" />
                                                            <div className="author-info">
                                                                <h6 className="color-gray-700">user</h6><span className="color-gray-700 text-sm">25 April 2022</span>
                                                            </div>
                                                ...
                                                <div className="card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn">
                                                    ...
                                                    <div className="card-info"><Link href="/single-sidebar">
                                                        <h3 className="mb-20 color-white">5 Resources To Find Diverse Stock Imaimgs For Your Website</h3></Link>
                                                        <p className="color-gray-500">Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped lynx far that and jeepers giggled far and far</p>
                                                        <div className="row mt-20">
                                                            <div className="col-7"><Link className="color-gray-700 text-sm mr-15" href="/blog-archive"># Travel</Link><Link className="color-gray-700 text-sm" href="/blog-archive"># Lifestyle</Link></div>
                                                            <div className="col-5 text-end"><span className="color-gray-700 text-sm timeread">3 mins read</span></div>
                                            ...
                                            <nav className="mb-50">
                                                <ul className="pagination">
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".0s"><Link className="paimg-link paimg-prev" href="#"><i className="fi-rr-arrow-small-left" /></Link></li>
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".1s"><Link className="paimg-link" href="#">1</Link></li>
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".2s"><Link className="paimg-link active" href="#">2</Link></li>
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".3s"><Link className="paimg-link" href="#">3</Link></li>
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".4s"><Link className="paimg-link" href="#">...</Link></li>
                                                    <li className="paimg-item wow animate__animated animate__fadeIn" data-wow-delay=".5s"><Link className="paimg-link paimg-next" href="#"><i className="fi-rr-arrow-small-right" /></Link></li>
                                                </ul>
                                            </nav>
                                        </div>
                                    </div>
